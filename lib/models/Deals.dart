...
class Deals {
  ...
  const Deals._internal({required this.id, required company_logo, required company_name, required company_description, required seeking, required status}): _company_logo = company_logo, _company_name = company_name, _company_description = company_description, _seeking = seeking, _status = status;
  
  factory Deals({String? id, required String company_logo, required String company_name, required String company_description, required String seeking, required String status}) {
  ...
  Deals copyWith({String? id, String? company_logo, String? company_name, String? company_description, String? seeking, String? status}) {
    return Deals._internal(
      id: id ?? this.id,
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'company_logo': _company_logo, 'company_name': _company_name, 'company_description': _company_description, 'seeking': _seeking, 'status': _status
  };
